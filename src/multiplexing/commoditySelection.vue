  ...
  methods: {
    ...
    getData() {
      ...
      this.oneTitle = this.selectionObj.Onedata[0].attrTitleEng
        ...
        : "";
      this.twoTitle = this.selectionObj.Twodata[0]
        ? this.selectionObj.Twodata[0].attrTitleEng
        : "";
    ...
    setMakeItem() {
      ...
      if (this.selectionObj.Twodata.length == 0) {
        if (typeof onefun(this.checkList, this.makeupdata) == "object") {
          this.makeItem = Object.assign(
            {},
            this.makeItem,
            onefun(this.checkList, this.makeupdata)
          );
          this.goodNumber = this.makeItem.canSalesNum
            ? this.makeItem.numIntervalStart
            : 0;
        ...
        if (typeof we(this.checkList, this.makeupdata) == "object") {
          this.makeItem = Object.assign(
            {},
            this.makeItem,
            we(this.checkList, this.makeupdata)
          );
          this.goodNumber = this.makeItem.canSalesNum
            ? this.makeItem.numIntervalStart
            : 0;
