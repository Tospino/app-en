  ...
  <div class="dfk">
    <div class="good-detail" v-for="dfkData in dfkDataList" :key="dfkData.orderId">
      ...
      <div
        ...
        @click="toOrderDetail(detail.orderId)"
        v-for="detail in dfkData.detailList2"
        :key="detail.detailId"
      >
        <div class="good-detail-img">
          <img v-lazy="$webUrl+detail.skuImg" />
        </div>
        ...
        <div class="price">
          ...
          <div
            class="p4 through"
            v-if="detail.originPriceWebsite"
          >{{detail.currencySignWebsite}}{{detail.originPriceWebsite}}</div>
          <div class="p4">x{{detail.detailNum}}</div>
          <div class="p2">
      ...
      <div v-if="dfkData.orderStatusApp != 1">
        ...
        <div class="good-detail-footer">
          ...
          <div
            class="lan"
            v-if="dfkData.orderStatusApp == 2 && dfkData.canComplete == 1"
            @click="receiGood(dfkData)"
          >
      ...
      <div v-else>
        <div class="good-detail-dfh-footer">
          ...
          <div class="dfh-footer-bottom">
            ...
            <span>Total:</span>
            <span
              class="c-orange font-30"
            >{{dfkData.currencySignWebsite}}{{dfkData.orderAmountWebsite}}</span>
