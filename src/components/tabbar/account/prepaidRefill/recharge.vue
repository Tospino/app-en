...
<!-- 账户余额 -->
    <div class="account-balance">
        ...
        <div class="balance-bottom">
            ...
            <div class="btn-next" @click="showpaymen" :style="{backgroundColor:(disabledSubmit?'#FA5300':'#999')}">Add Now</div>
        </div>
...
export default {
    ...
    computed: {
        disabledSubmit(){
            return this.currentIndex != null && this.phone && (Number(this.customMony) || this.currentItem.discountPrice)
        }
    },
    created() {
