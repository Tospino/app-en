      ...
      <div class="bscroll-con" v-if="dataList.length>0">
        <div class="good-detail" v-for="(product,index) in dataList" :key="index">
          <div class="good-detail-header">
            ...
            <span
              class="fl-right c-orange ft-24"
            >{{orderStatus(product.orderStatusApp,'statusList')}}</span>
            <br />
            <span>order No:{{product.saleOrderSn}}</span>
          </div>
          <div
            class="good-detail-content"
            v-for="(detail,index) in product.detailList2"
            :key="index"
          >
          ...
          <div class="good-detail-dfh-footer">
            <div
              class="dfh-footer-top"
              v-if="product.detailList.length > 2"
              @click="shousuo(product)"
            >
