    ...
    <div class="address-p4">
      <div class="p4-middle">
        ...
        <div class="middle-p1">
          ...
          <span
            class="t-right c-orange"
          >{{detailData.currencySignWebsite}}{{detailData.orderFareWebsite}}</span>
        </div>
        <div class="middle-p1">
          <span class="c-999 t-left">Total refund:</span>
          <span
            class="t-right c-orange"
          >{{detailData.currencySignWebsite}}{{detailData.orderAmountWebsite}}</span>
        </div>
      </div>
    </div>
