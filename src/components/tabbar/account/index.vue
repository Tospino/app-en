<template>
	...
	<section>
		...
		<div class="account christmas_bg_nav" v-show="christmasBg">
			<div class="header flex_space">
				...
				<div class="christmas_bg_nav_right">
					<van-icon name="chat-o" size="17px" @click="jumpRouter('消息')" color="#fff" />
				</div>
			</div>
		</div>
		...
		<div class="account">
			...
			<van-cell-group class="border-0">
				<van-field v-model="username" clearable right-icon="arrow" placeholder="After Sale Service" left-icon="arrow"
				 disabled @click="jumpRouter('售后内容')">
					<div slot="left-icon" size="small" type="primary" class="icon-left">
			...
			<van-cell-group class="border-0">
				<van-field v-model="username" clearable right-icon="arrow" placeholder="My coupons" left-icon="arrow" disabled
			...
			<van-cell-group class="border-0">
				<van-field v-model="username" clearable right-icon="arrow" placeholder="My Balance" left-icon="arrow" disabled
				 @click="jumpRouter('账户余额')" v-if="false">
					<div slot="left-icon" size="small" type="primary" class="icon-left">
			...
			<van-cell-group class="border-0" @click="service">
				<van-field v-model="username" clearable right-icon="arrow" placeholder="Customer Service" left-icon="arrow"
				 disabled>
					<div slot="left-icon" size="small" type="primary" class="icon-left">
			...
			<van-cell-group class="border-0">
				<van-field v-model="username" clearable right-icon="arrow" placeholder="Bind Your Facebook Account" left-icon="arrow"
				 disabled @click="toBindThird">
					<div slot="left-icon" size="small" type="primary" class="icon-left">
			...
			<van-cell-group class="border-0">
				<van-field v-model="username" clearable right-icon="arrow" placeholder="Change Country/District" left-icon="arrow"
				 disabled @click="toLanguage('语言')">
					<div slot="left-icon" size="small" type="primary" class="icon-left">
			...
			<van-cell-group class="border-0">
				<van-field v-model="username" clearable right-icon="arrow" placeholder="Add Minutes" left-icon="arrow" disabled
