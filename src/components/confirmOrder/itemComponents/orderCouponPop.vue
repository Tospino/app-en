  ...
  <div class="orderCouponPop" v-show="order">
    <div class="order-selection">
      ...
      <div class="selection-conten">
        <!-- 可领取优惠券 -->
        <div v-if="active==0">
          <div class="youhuiquan-item item-one" v-for="(i,index) in orderCoupon" :key="index">
            <div class="youhuiquan-left left-one">
              <span class="youhuiquan-left-biao biao-one">{{i.qianBiao}}{{jn}}</span>
              <p class="youhuiquan-left-money money-one">
                {{i.money}}
                <i>{{i.off}}</i>
              </p>
              <div class="youhuiquan-left-ms">
                <p class="youhuiquan-left-m m-one">{{i.type}}</p>
                <p class="youhuiquan-left-m m-one">{{i.valid}}</p>
              </div>
            ...
            <div class="youhuiquan-right">
              <div class="youhuiquan-right-header">
                <span class="youhuiquan-right-title right-title-one">{{i.title}}</span>
              </div>
              <div class="youhuiquan-right-main right-main-one">
                <p
                  class="youhuiquan-left-mc mc-one"
                >For {{i.qianBiao}}{{jn}} {{i.moneys}} consumption</p>
                <van-button
                  v-if="btnBox==true"
                  round
                  type="info"
                ...
                <div v-else class="checkedBox">
                  <van-checkbox v-model="checked" checked-color="#FA5300"></van-checkbox>
                </div>
              </div>
            </div>
          </div>
        ...
        <!-- 不可领取 -->
        <div v-else-if="active==1" class="youhuiquan-two" v-for="(i,index) in orderCoupon" :key="index">
          ...
          <div class="youhuiquan-reason">
              ...
              <p class="reason-content">Reason why goods are not available Reason why goods are not available Reason why goods are not available.</p>
          </div>
        </div>
      </div>
    </div>
