 ...
 * @LastEditTime: 2021-01-04 13:46:44
 * @LastEditors: 曹建勇
...
export default new Router({
    routes: [{
            ...
            name: "引导页",
            component: () =>
                import (`@/components/guidePage/index.vue`)
        },
        {
            path: "/login",
            name: "登录",
        ...
        },
        {
            ...
            name: "注册",
            component: () =>
                import (`@/components/login/register/index.vue`)
        },

        {
            ...
            name: "设置支付密码母页",
            component: () =>
                import (`@/components/login/register/parenPay`),
            children: [{
                    path: "payPassword",
                    name: "设置支付密码",
                    component: () =>
                        import (`@/components/login/register/payPassword.vue`)
                },
                {
                    path: "payPasswordTwo",
                    name: "确定支付密码",
...

        {
            ...
            name: "商品详情",
            component: () =>
                import (`@/components/tabbar/home/commodityDetails.vue`)
        },
        {
            path: "/commodityDetails/evaluaDetails",
            name: "商品详情评价",
            component: () =>
                import (`@/components/tabbar/home/evaluaDetails.vue`)
        },

        {
            ...
            name: "我的足迹",
            component: () =>
                import (`@/components/tabbar/account/footprint/index.vue`)
        },
        ...
        // myOrderParent
        {
            ...
            children: [{
                    ...
                    name: "我的订单",
                    component: () =>
                        import (`@/components/tabbar/account/myOrder/index`)
                },
                {
                    path: "editAddress",
                    name: "我的订单修改地址",
                ...
                },
                {
                    ...
                    name: "退款页面",
                    component: () =>
                        import (`@/components/tabbar/account/myOrder/refund`)
                },
                {
...

        {
            ...
            name: "评价",
            component: () =>
                import (`@/components/tabbar/account/evaluate/index`),
            children: [{
                    path: "noShopping",
                    name: "评价没有购物",
                    component: () =>
        ...
        },
        {
            ...
            children: [{
                ...
                },
                {
                    ...
                    name: "选择列表",
                    component: () =>
                        import (`@/multiplexing/choiceList`)
                },
                {
                ...
                },
                {
                    ...
                    name: "授权详情",
                    component: () =>
                        import (`@/components/tabbar/account/thirdLogin/details.vue`)
                },
                {
                    path: "aboutTospino",
                    name: "About TOSPINO",
        ...
        //话费充值
        {
            ...
            name: "话费充值母页",
            component: () =>
                import (`@/multiplexing/router.vue`),
            children: [{
                    path: "recharge",
                    name: "话费充值",
                    component: () =>
...

        {
            ...
            name: "售后",
            component: () =>
                import (`@/components/tabbar/account/afterSales/index`),
            children: [{
...

        {
            ...
            children: [{
                    ...
                    name: "历史记录",
                    component: () =>
                        import (`@/components/search/searchRecord.vue`)
                },
                {
                    path: '/accountBalance/commentDetail',
                    name: '评论详情',
                ...
                },
                {
                    ...
                    children: [{
                        ...
                        },
                        {
                            ...
                            name: '余额充值',
                            component: () =>
                                import (`@/components/tabbar/account/prepaidRefill/prepaiRecharge`)
                        },
                    ]
                },
                ...
                },
                {
                    ...
                    name: "无搜索商品",
                    component: () =>
                        import (`@/components/search/noSearch.vue`)
                },
                {
                ...
                },
                {
                    ...
                    name: "搜索商品1",
                    component: () =>
                        import (`@/components/search/searchGoodsOne.vue`),
                    meta: {
                        keepAlive: true,
                        isBack: true
                    }
        ...
        },
        {
            ...
            name: "确认订单",
            component: () =>
                import (`@/components/confirmOrder/index.vue`),
            children: [{
                    path: "orderContent",
                    name: "确认订单详情",
                    component: () =>
                        import (`@/components/confirmOrder/orderContent.vue`)
                },
                {
                    path: "confirmSuccess",
                    name: "确认订单提交成功",
                ...
                },
                {
                    ...
                    name: "添加银行卡",
                    component: () =>
                        import (`@/components/confirmOrder/addBankcar.vue`)
                },
                {
                    path: "resetPassword",
                    name: "重置支付密码",
                    component: () =>
                        import (`@/components/confirmOrder/resetPassword.vue`)
                },
                {
                ...
                },
                {
                    ...
                    name: "确认订单收货地址",
                    component: () =>
                        import (`@/components/confirmOrder/orderAddress.vue`)
                }
            ]
        },

        {
            ...
            name: "主页子页面",
            component: () =>
                import (`@/components/tabbar/home/homeItem/index.vue`),
            children: [{
                    path: "flashSale",
                    name: "限时抢购",
                    component: () =>
...

        {
            ...
            name: "控制",
            component: () =>
                import (`@/components/tabbar/person.vue`),
            children: [{
                    path: "home",
                    name: "首页",
                    component: () =>
                        import (`@/components/tabbar/home/index.vue`),
                    meta: {
                        keepAlive: true,
                        isBack: true
                    }
                },
                {
                    ...
                    name: "分类",
                    component: () =>
                        import (`@/components/tabbar/classify/index.vue`),
                    // meta: {
                    //     keepAlive: true
                    // }
                },
                {
                    ...
                    name: "客服",
                    component: () =>
                        import (`@/components/tabbar/account/OnlineService.vue`),
                    meta: {
                        keepAlive: true
                    }
                },
                {
                    ...
                    name: "购物车",
                    component: () =>
                        import (`@/components/tabbar/shoppingCart/index.vue`)
                },
                {
                    path: "account",
                    name: "我的",
                    component: () =>
                        import (`@/components/tabbar/account/index.vue`)
                }
            ]
        },
        {
            ...
            name: "收藏夹",
            component: () =>
                import (`@/components/tabbar/account/favorites/index.vue`)
        },
        // {
        //     path: "OnlineService",
        //     name: "客服",
        //     component: () => import(`@/components/tabbar/account/OnlineService.vue`),
        //     meta: {
        //         keepAlive: true
        //     }
        // },
        {
            ...
            name: "语言",
            component: () =>
                import (`@/components/tabbar/account/language/index`)
        },
        {
            path: "/language/languSubPage",
            name: "语言选择页",
            component: () =>
                import (`@/components/tabbar/account/language/subPage`)
        },

        {
            ...
            name: "消息",
            component: () =>
                import (`@/components/tabbar/account/information/index`)
        },
        {
            path: "/information/inforDetails",
            name: "消息详情",
            component: () =>
                import (`@/components/tabbar/account/information/details`)
        },

        {
            ...
            name: "扫码",
            component: () =>
                import (`@/multiplexing/sweepCode`)
        },
        {
            path: "/thirdSuccess",
            name: "第三方支付页成功",
            component: () =>
                import (`@/components/confirmOrder/thirdSuccess`)
        },
        {
            path: "/thirdLose",
            name: "第三方支付页失败",
